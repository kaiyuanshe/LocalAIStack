# Tencent Plugin - Cross-Platform Build Guide
...
The plugin provides four services:
...
- **Endpoint**: Special URL (https://hunyuan.tencentcloudapi.com/)
- **Streaming**: ❌ Not supported
- **Protocol**: HTTP

### 4. Text-to-Speech Service
- **Endpoint**: Special URL (https://tts.tencentcloudapi.com)
- **Streaming**: ❌ Not supported
- **Protocol**: HTTP
