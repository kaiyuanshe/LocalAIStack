...
# 
# Deepseek Plugin - Cross-platform Build Script
#*****************************************************************************
...
BINARY_NAME="deepseek-plugin"

echo "🚀 Building deepseek-plugin v${VERSION} for all platforms..."
echo ""
