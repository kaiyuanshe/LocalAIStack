# Baidu Plugin - Cross-Platform Build Guide
...
- **Endpoint**: Special URL (https://tsn.baidu.com/text2audio)
- **Streaming**: ❌ Not supported
- **Protocol**: HTTP
